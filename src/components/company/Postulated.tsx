...
const Postulated: FC = ({ ...rest }) => {
    ...
    const [selectedCustomerIdPostulated, setSelectedCustomerIdPostulated] =
        useState<string[]>([]);
    const [selectedCustomerIdsAccepts, setSelectedCustomerIdsAccepts] =
        useState<string[]>([]);
    ...
    const handleSelectOnePostulated = (uid: any) => {
        ...
        if (selectedIndex === -1) {
            newSelectedCustomerIdPostulated =
                newSelectedCustomerIdPostulated.concat(
    ...
    const handleSelectOneAccepts = (uid: any) => {
        ...
        if (selectedIndex === -1) {
            newSelectedCustomerIdsAccepts =
                newSelectedCustomerIdsAccepts.concat(
                                        ...
                                        {projectId.accepts
                                            ...
                                            .map((accept: any) => (
                                                <TableRow
                                                    ...
                                                    key={accept._id}
                                                    selected={
                                                        selectedCustomerIdsAccepts.indexOf(
                                                            accept._id
                                                        ) !== -1
                                                    }
                                                >
                                                    ...
                                                    >
                                                      <Box sx={{
                                                        ...
                                                        <IconButton
                                                            disabled={
                                                                selectedCustomerIdsAccepts.length <
                                                                2
                                                            }
                                                        >
                                                            <DoneAllIcon
